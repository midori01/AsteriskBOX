...
func TestNormalizeProbeDataPlanes(t *testing.T) {
	tests := []struct {
		...
		{name: "default all", options: KernelProbeOptions{Mode: KernelProbeModeAll}, local: KernelProbeDataPlaneTC, shared: KernelProbeDataPlanePacketRewrite},
		{name: "default local", options: KernelProbeOptions{Mode: KernelProbeModeLocal}, local: KernelProbeDataPlaneTC},
