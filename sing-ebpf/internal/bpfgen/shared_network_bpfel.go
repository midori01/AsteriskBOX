...
const (
	...
	SharedNetworkProgSingEbpfSharedEgress   = "sing_ebpf_shared_egress"
	SharedNetworkProgSingEbpfSharedIngress  = "sing_ebpf_shared_ingress"
)
...
type SharedNetworkProgramSpecs struct {
	SingEbpfSharedEgress  *ebpf.ProgramSpec `ebpf:"sing_ebpf_shared_egress"`
	SingEbpfSharedIngress *ebpf.ProgramSpec `ebpf:"sing_ebpf_shared_ingress"`
}
...
type SharedNetworkPrograms struct {
	SingEbpfSharedEgress  *ebpf.Program `ebpf:"sing_ebpf_shared_egress"`
	SingEbpfSharedIngress *ebpf.Program `ebpf:"sing_ebpf_shared_ingress"`
}

func (p *SharedNetworkPrograms) Close() error {
	return _SharedNetworkClose(
		p.SingEbpfSharedEgress,
		p.SingEbpfSharedIngress,
	)
}
