...
#define SB_SHARED_STAT_INGRESS_PASS 2U
#define SB_SHARED_STAT_EGRESS_PASS 3U
#define SB_SHARED_STAT_INGRESS_FRAGMENT_PASS 4U
#define SB_SHARED_STAT_EGRESS_FRAGMENT_PASS 5U
#define SB_SHARED_STAT_COUNT 6U
...
#define SB_SHARED_FLAG_FORCE_INTERCEPT_IPV4 (1U << 16)
#define SB_SHARED_FLAG_FORCE_INTERCEPT_IPV6 (1U << 17)
