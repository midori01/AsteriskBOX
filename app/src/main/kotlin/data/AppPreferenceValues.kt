...
internal fun AppState.preferenceValues(): Map<String, AppPreferenceValue> = buildMap {
    ...
    boolean(KeyEbpfLocalBypassPrivateAddress, ebpfLocalBypassPrivateAddress)
    stringList(KeyEbpfLocalBypassIpCidr, ebpfLocalBypassIpCidr)
    stringList(KeyEbpfLocalBypassPort, ebpfLocalBypassPort)
